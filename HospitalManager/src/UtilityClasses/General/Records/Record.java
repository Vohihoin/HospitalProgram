 ...
 * in a record object that will be added to the patient's arraylist of records)
 * Needs to be very complex object, able to handle the patient's complex information from a visit.
 */
public class Record {

    /*IDEAS*/
    // could contain links to different files, like maybe a file for tests, a file for doctor's notes
